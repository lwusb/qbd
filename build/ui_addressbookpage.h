...
public:
    ...
    void setupUi(QWidget *AddressBookPage)
    {
        ...
        AddressBookPage->resize(994, 380);
...
#ifndef QT_NO_TOOLTIP
        signMessage->setToolTip(QApplication::translate("AddressBookPage", "<html><head/><body><p>Sign a message to prove you own a QBDCoin address</p></body></html>", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        signMessage->setText(QApplication::translate("AddressBookPage", "Sign &Message", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        verifyMessage->setToolTip(QApplication::translate("AddressBookPage", "<html><head/><body><p>Verify a message to ensure it was signed with a specified QBDCoin address</p></body></html>", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
