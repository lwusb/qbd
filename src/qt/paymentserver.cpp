...
const QString BITCOIN_IPC_PREFIX("QBDCoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click QBDCoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start QBDCoin: click-to-pay handler");
    else
...
{
    // clicking on QBDCoin: URLs creates FileOpen events on the Mac:
