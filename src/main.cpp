...
// Copyright (c) 2017 The QBDCoin Developers
...
uint256 hashGenesisBlock("000001a03202341112cee01c25943fa1a303784210b261e935425d9569799199");//，替换2.0
static const unsigned int timeGenesisBlock = 1525837494;//1456048686;//替换1.0
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // joy joy 设置全网允许的最小难度，低于这个难度的block是不会被挖掘的，默认32
...
const string strMessageMagic = "QBDCoin Signed Message:\n";
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("273b06be045306b3b05b8bb528e485c839e67ad21e3124b2f47dabdb363a2acc");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
       const char* pszTimestamp = "already in already databases we QBDCoin from USA with Transactions.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nNonce   = 1823443;//替换1.2，替换2.2
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0314a63789e9ef7e012bee99b6f3d56c95a2d1d16f4ba8714030c05df5684c30"));//替换2.1
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("QBDCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("QBDCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("QBDCoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("QBDCoin-miner");
    ...
    try { loop {
        ...
        printf("Running QBDCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("QBDCoinMiner terminated\n");
        throw;
    }
}
